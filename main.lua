...
wait(1)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Credit",Text = "Getting Boxer + Fan" ,Duration = 10, Icon = "rbxthumb://type=Asset&id=9649923610&w=150&h=150",Button1 = "alright dud"})
wait(1)
